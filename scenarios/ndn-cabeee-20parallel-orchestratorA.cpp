...
*       \--------/        -----------------------------------
* 
*     NS_LOG=CustomAppConsumer:CustomAppProducer:DagForwarderApp ./waf --run=ndn-cabeee-20parallel-orchestratorA
*/
int
...
*/
  ...
  //ndn::L3RateTracer::InstallAll("rate-trace_cabeee-20parallel-orchestratorA.txt", Seconds(0.1));
  //ndn::CsTracer::InstallAll("cs-trace_cabeee-20parallel-orchestratorA.txt", Seconds(0.1));
