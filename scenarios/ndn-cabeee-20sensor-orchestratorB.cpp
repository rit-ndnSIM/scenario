...
*/
  ...
  ndn::L3RateTracer::InstallAll("rate-trace_cabeee-20sensor-parallel-orchestratorB.txt", Seconds(0.1));
  ndn::CsTracer::InstallAll("cs-trace_cabeee-20sensor-parallel-orchestratorB.txt", Seconds(0.1));
