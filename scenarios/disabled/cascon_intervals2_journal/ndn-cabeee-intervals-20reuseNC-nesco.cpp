...
main(int argc, char* argv[])
{
  ...
  topologyReader.SetFileName("topologies/topo-cabeee-Abilene2.txt");
  topologyReader.Read();
  ...
  Ptr<Node> rtrG1   = Names::Find<Node>("rtr-G1");
  Ptr<Node> rtrG1a  = Names::Find<Node>("rtr-G1a");
  Ptr<Node> rtrG1b  = Names::Find<Node>("rtr-G1b");
  ...
  Ptr<Node> rtrI1   = Names::Find<Node>("rtr-I1");
  Ptr<Node> rtrI1a  = Names::Find<Node>("rtr-I1a");
  Ptr<Node> rtrI1b  = Names::Find<Node>("rtr-I1b");
  Ptr<Node> rtrI2   = Names::Find<Node>("rtr-I2");
  Ptr<Node> rtrI2a  = Names::Find<Node>("rtr-I2a");
  Ptr<Node> rtrI2b  = Names::Find<Node>("rtr-I2b");
  Ptr<Node> rtrJ    = Names::Find<Node>("rtr-J");
  Ptr<Node> rtrJ1   = Names::Find<Node>("rtr-J1");
  Ptr<Node> rtrJ1a  = Names::Find<Node>("rtr-J1a");
  Ptr<Node> rtrK    = Names::Find<Node>("rtr-K");
  Ptr<Node> rtrK1   = Names::Find<Node>("rtr-K1");
  Ptr<Node> rtrK1a  = Names::Find<Node>("rtr-K1a");
  Ptr<Node> rtrK1b  = Names::Find<Node>("rtr-K1b");
  ...
  ndnHelper.Install(rtrE1a);
  ndnHelper.Install(rtrF2a);
  ndnHelper.Install(rtrG1a);
  ndnHelper.Install(rtrG1b);
  ndnHelper.Install(rtrH1a);
  ndnHelper.Install(rtrI1a);
  ndnHelper.Install(rtrI1b);
  ndnHelper.Install(rtrI2a);
  ndnHelper.Install(rtrI2b);
  ndnHelper.Install(rtrJ1a);
  ndnHelper.Install(rtrK1a);
  ndnHelper.Install(rtrK1b);
  ...
  sensorApp.SetAttribute("UniformFreshness", UintegerValue(0));     // this will set the FreshnessPeriod_ms once using the value below
  ...
  // The freshness values below were picked somewhat randomly, but we hardcode them because we use exactly the same values in emulation.
  // TODO: we should use uniformFreshness value of 2 (generate random value for every packet) and do the same in emulation. Bump up the interests from 100 to 1000?
  ...
  ndn::L3RateTracer::InstallAll("rate-trace_cabeee-20reuseNC-nesco.txt", Seconds(100.0));
