...
main(int argc, char* argv[])
{
  ...
  ndn::AppHelper forwarderSDApp("DagForwarderSDApp");
  forwarderSDApp.SetPrefix(Prefix);
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("sensor"));

  sensorApp.Install(router3).Start(Seconds(0));
  forwarderSDApp.Install(router3).Start(Seconds(0));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service1"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service2"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service3"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service4"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service5"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service6"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service7"));
  ...
  forwarderSDApp.SetAttribute("Service", StringValue("service8"));
