...
main(int argc, char* argv[])
{
  ...
  ndnHelper.setCsSize(1); // enable/disable content store
  ...
  sensorApp.Install(producer).Start(Seconds(0));
  sensorApp.SetPrefix(Prefix);
  sensorApp.SetAttribute("FreshnessPeriod_ms", UintegerValue(50));
  ...
  sensorApp.Install(producer).Start(Seconds(0));
  sensorApp.SetPrefix(Prefix);
  sensorApp.SetAttribute("FreshnessPeriod_ms", UintegerValue(10));
