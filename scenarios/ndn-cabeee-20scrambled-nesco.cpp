...
*       \--------/        ----------------
* 
*     NS_LOG=CustomAppConsumer:CustomAppProducer:DagForwarderApp ./waf --run=ndn-cabeee-20scrambled
*/
int
...
*/
  ...
  //ndn::L3RateTracer::InstallAll("rate-trace_cabeee-20scrambled.txt", Seconds(1.0));
  //ndn::CsTracer::InstallAll("cs-trace_cabeee-20scrambled.txt", Seconds(1.0));
