                    ...
                    for hostRatio in HOSTRATIO_LIST:
                        ...
                        for prefix in PREFIX_LIST:
                            ...
                            if prefix == "icnfc":
                                ...
                                base_name = f"{padded_catCode}-hR_{hr_str}-{ccr_str}-Srv_{num_services:02d}-Nodes_{num_nodes:02d}--sn-{topoCategory}-{workflowCategory}-1_{prefix}"
                            ...
                            if prefix == "ndnfcp":
                                ...
                                base_name = f"{padded_catCode}-hR_{hr_str}-{ccr_str}-Srv_{num_services:02d}-Nodes_{num_nodes:02d}--sn-{topoCategory}-{workflowCategory}-2_{prefix}"
                            ...
                            if prefix == "or3":
                                ...
                                base_name = f"{padded_catCode}-hR_{hr_str}-{ccr_str}-Srv_{num_services:02d}-Nodes_{num_nodes:02d}--sn-{topoCategory}-{workflowCategory}-3_{prefix}"
                            ...
                            if prefix == "nesco":
                                ...
                                base_name = f"{padded_catCode}-hR_{hr_str}-{ccr_str}-Srv_{num_services:02d}-Nodes_{num_nodes:02d}--sn-{topoCategory}-{workflowCategory}-4_{prefix}"
                                ...
                                base_name = f"{padded_catCode}-hR_{hr_str}-{ccr_str}-Srv_{num_services:02d}-Nodes_{num_nodes:02d}--sn-{topoCategory}-{workflowCategory}-5_{prefix}"
...
if __name__ == "__main__":
    ...
    # same DAGs were handed to every run, which meant any quirk of that single set was baked into all
