...
// cabeee-dag-serviceDiscovery-app.hpp

#ifndef DAG_SERVICEDISCOVERY_APP_H_
#define DAG_SERVICEDISCOVERY_APP_H_
 ...
 */
class DagServiceDiscoveryApp : public ndn::App {
public:
  // register NS-3 type "DagServiceDiscoveryApp"
  static TypeId
  GetTypeId();

  DagServiceDiscoveryApp();
...
#endif // DAG_SERVICEDISCOVERY_APP_H_
