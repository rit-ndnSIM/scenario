...
// cabeee-custom-app-csUpdater.hpp

#ifndef CUSTOM_APP_CSUPDATER_H_
#define CUSTOM_APP_CSUPDATER_H_
 ...
 */
class CustomAppCsUpdater : public ndn::App {
public:
  // register NS-3 type "CustomAppCsUpdater"
  static TypeId
  GetTypeId();
