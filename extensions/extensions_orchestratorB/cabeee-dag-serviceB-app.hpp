...
// cabeee-dag-serviceB-app.hpp

#ifndef DAG_SERVICEB_APP_H_
#define DAG_SERVICEB_APP_H_
 ...
 */
class DagServiceB_App : public ndn::App {
public:
  // register NS-3 type "DagServiceB_App"
  static TypeId
  GetTypeId();
