...
#ifndef CUSTOM_APP_CONSUMER_POISSON_H_
#define CUSTOM_APP_CONSUMER_POISSON_H_
 ...
 */
class CustomAppConsumerPoisson : public ndn::App {
public:
  // register NS-3 type "CustomAppConsumerPoisson"
  static TypeId
  GetTypeId();

  CustomAppConsumerPoisson();
...
#endif // CUSTOM_APP_CONSUMER_POISSON_H_
