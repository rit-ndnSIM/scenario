...
CustomAppConsumer2::GetTypeId()
{
  static TypeId tid = TypeId("CustomAppConsumer2")
    ...
    .AddAttribute("Prefix", "Requested prefix", StringValue("/dumb-interest"),
                    ndn::MakeNameAccessor(&CustomAppConsumer2::m_prefix), ndn::MakeNameChecker())
    .AddAttribute("Service", "Requested service", StringValue("/dumb-interest"),
                    ndn::MakeNameAccessor(&CustomAppConsumer2::m_service), ndn::MakeNameChecker())
    .AddAttribute("Workflow", "Requested workflow", StringValue("/workflows/dummy-workflow"),
                    MakeStringAccessor(&CustomAppConsumer2::m_dagPath), MakeStringChecker())
...
*/
  ...
  std::cout << "\n  Consumer 2 result: " <<  finalResult << std::endl << "\n\n";
