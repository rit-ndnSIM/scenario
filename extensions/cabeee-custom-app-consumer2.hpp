...
#ifndef CUSTOM_APP_CONSUMER2_H_
#define CUSTOM_APP_CONSUMER2_H_
 ...
 */
class CustomAppConsumer2 : public ndn::App {
public:
  // register NS-3 type "CustomAppConsumer2"
  static TypeId
  GetTypeId();
