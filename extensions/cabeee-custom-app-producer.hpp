...
// cabeee-custom-app-producer.hpp

#ifndef CUSTOM_APP_PRODUCER_H_
#define CUSTOM_APP_PRODUCER_H_
 ...
 */
class CustomAppProducer : public ndn::App {
public:
  // register NS-3 type "CustomAppProducer"
  static TypeId
  GetTypeId();
