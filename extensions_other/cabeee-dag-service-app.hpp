...
// cabeee-dag-service-app.hpp

#ifndef DAG_SERVICE_APP_H_
#define DAG_SERVICE_APP_H_
 ...
 */
class DagServiceApp : public ndn::App {
public:
  // register NS-3 type "DagServiceApp"
  static TypeId
  GetTypeId();
